const myTheme = {
  ...
  badge: {
    ...
    success:
      "text-emerald-500 bg-emerald-100 dark:bg-emerald-800 dark:text-emerald-100",
  ...
  textarea: {
    ...
    active:
      "focus:border-purple-400 border-gray-300 dark:border-gray-600 dark:focus:border-gray-600 dark:bg-gray-700",
  ...
  input: {
    ...
    invalid:
      "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 ",
    radio:
      "text-emerald-500 form-radio focus:border-emerald-400 focus:outline-none ",
    checkbox:
      "text-emerald-500 form-checkbox focus:border-emerald-500 focus:outline-none rounded",
  },
  // HelperText
  helperText: {
    base: "text-xs",
