            ...
            <li className="relative" key={route.name}>
              {route?.outside ? (
                <a
                  ...
                  target="_blank"
                  className="px-6 py-4 inline-flex items-center cursor-pointer w-full text-sm font-semibold transition-colors duration-150 hover:text-emerald-700 dark:hover:text-gray-200"
                  rel="noreferrer"
                >
